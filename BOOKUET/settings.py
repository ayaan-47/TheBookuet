"""
Django settings for BOOKUET project.
...
SECRET_KEY = 'vt5!m62=k_+bu+o#bb-k0&u^@b&=s=&_#-281p1x7s4)+-=z#h'
...
WSGI_APPLICATION = 'BOOKUET.wsgi.application'
